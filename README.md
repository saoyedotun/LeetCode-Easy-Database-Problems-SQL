...
2. [Second Highest Salary](second-highest-salary.sql) | [LeetCode 176](https://leetcode.com/problems/second-highest-salary/)

3. [Employees Earning More Than Their Managers](employees-earning-more-than-their-managers.sql) | [LeetCode 181](https://leetcode.com/problems/employees-earning-more-than-their-managers/)

4. [Duplicate Emails](duplicate-emails.sql) | [LeetCode 182](https://leetcode.com/problems/duplicate-emails/)

5. [Customers Who Never Order](customers-who-never-order.sql) | [LeetCode 183](https://leetcode.com/problems/customers-who-never-order/)

6. [Delete Duplicate Emails](delete-duplicate-emails.sql) | [LeetCode 196](https://leetcode.com/problems/delete-duplicate-emails/)

7. [Rising Temperature](rising-temperature.sql) | [LeetCode 197](https://leetcode.com/problems/rising-temperature/)

8. [Game Play Analysis I](game-play-analysis-i.sql) | [LeetCode 511](https://leetcode.com/problems/game-play-analysis-i/)
